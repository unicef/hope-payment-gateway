...
api_patterns = [
    ...
    path(r"wu/", include("hope_payment_gateway.apps.western_union.urls", namespace="wu")),
    path(r"rest/", include("hope_payment_gateway.api.western_union.urls", namespace="rest")),
]
