...
class ExportTemplate(models.Model):
    ...
    delimiter = models.CharField(choices=list(zip(delimiters, strict=delimiters)), default=",")
    quotechar = models.CharField(choices=list(zip(quotes, strict=quotes)), default="'")
