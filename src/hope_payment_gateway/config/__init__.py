...
OPTIONAL = {
    ...
    "AZURE_TENANT_ID": (str, ""),
    "BITCASTER_BAE": (str, "", "Bitcaster API Endpoint (https://<token>@<host>/api/o/<org>/)"),
    "BITCASTER_CLIENT_CLASS": (str, "bitcaster_sdk.async_client.AsyncClient"),
    "BITCASTER_ENABLED": (bool, False, "Enable Bitcaster notifications; user sync requires Bitcaster server >= 3.1"),
    "BITCASTER_ORGANIZATION_SLUG": (str, "unicef"),
    "BITCASTER_PROJECT_SLUG": (str, "hope"),
    "BITCASTER_APPLICATION_SLUG": (str, "payment-gateway"),
    ...
    "MAILJET_SECRET_KEY": (str, "", "Mailjet API secret key"),
    "EMAIL_BACKEND": (str, "anymail.backends.mailjet.EmailBackend", "Email Backend"),
    "DEFAULT_FROM_EMAIL": (str, "", "Default sending email address"),
    "IGNORE_RECIPIENT_STATUS": (bool, True),
    "IGNORE_UNSUPPORTED_FEATURES": (bool, True),
    "REQUESTS_TIMEOUT": (int, 30),
    "DEBUG_API_REQUESTS": (bool, False),
    ...
    "PALPAY_HOST": (str, ""),
    "PALPAY_INSTRUCTION_POST": (str, ""),
    "PALPAY_CLIENT_ID": (str, ""),
    "PALPAY_CLIENT_SECRET": (str, ""),
    "SENTRY_DSN": (str, ""),
