...
def test_delivery_services(mock_wu_cls, user_with_ds_perm, client):
    corridor = CorridorFactory(destination_country="US", destination_currency="USD", template_code="1234")
...
@override_config(WESTERN_UNION_VENDOR_NUMBER="12345")
@patch("hope_payment_gateway.apps.fsp.western_union.admin.WesternUnionClient")
def test_delivery_services_with_query_params(mock_wu_cls, user_with_ds_perm, client):
    corridor = CorridorFactory(destination_country="US", destination_currency="USD", template_code="1234")
    mock_instance = mock_wu_cls.return_value
    mock_instance.das_delivery_services.return_value = {"title": "GetDeliveryServices"}
...
@override_config(WESTERN_UNION_VENDOR_NUMBER="12345")
@patch("hope_payment_gateway.apps.fsp.western_union.admin.WesternUnionClient")
def test_delivery_option_template(mock_wu_cls, user_with_dot_perm, client):
    corridor = CorridorFactory(destination_country="PH", destination_currency="PHP", template_code="4061")
    mock_instance = mock_wu_cls.return_value
...
@override_config(WESTERN_UNION_VENDOR_NUMBER="12345")
@patch("hope_payment_gateway.apps.fsp.western_union.admin.WesternUnionClient")
def test_delivery_option_template_with_query_params(mock_wu_cls, user_with_dot_perm, client):
    corridor = CorridorFactory(destination_country="PH", destination_currency="PHP", template_code="4061")
    mock_instance = mock_wu_cls.return_value
    mock_instance.das_delivery_option_template.return_value = {"title": "GetDeliveryOptionTemplate"}
