...
def test_client_error(wu):
    ...
    responses._add_from_file(file_path="tests/api/fsp/western_union/endpoints/send_client_error.yaml")
    payload = {
...
def test_client_non_std_error(wu):
    responses.patch("https://wugateway2pi.westernunion.com/SendmoneyValidation_Service_H2H")
    responses._add_from_file(file_path="tests/api/fsp/western_union/endpoints/send_client_non_std_error.yaml")
    payload = {
        "payment_record_code": "asdasdas",
        "first_name": "Aliyah",
        "last_name": "GRAY",
