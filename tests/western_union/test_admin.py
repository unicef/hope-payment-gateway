...
def test_admin_request(django_app, admin_user):
    with patch("hope_payment_gateway.apps.western_union.admin.requests_request"):
...
def test_admin_das_countries_currencies(django_app, admin_user):
    with patch("hope_payment_gateway.apps.western_union.admin.das_countries_currencies"):
...
def test_admin_das_destination_countries(django_app, admin_user):
    with patch("hope_payment_gateway.apps.western_union.admin.das_destination_countries"):
...
def test_admin_das_origination_currencies(django_app, admin_user):
    with patch("hope_payment_gateway.apps.western_union.admin.das_origination_currencies"):
...
def test_admin_das_destination_currencies(django_app, admin_user):
    with patch("hope_payment_gateway.apps.western_union.admin.das_destination_currencies"):
...
def test_admin_das_delivery_services(django_app, admin_user):
    with patch("hope_payment_gateway.apps.western_union.admin.das_delivery_services"):
...
def test_admin_das_delivery_option_template(django_app, admin_user):
    with patch("hope_payment_gateway.apps.western_union.admin.das_delivery_option_template"):
...
#     with patch("hope_payment_gateway.apps.western_union.admin.send_money_validation"):
...
#     with patch("hope_payment_gateway.apps.western_union.admin.send_money"):
...
#     with patch("hope_payment_gateway.apps.western_union.admin.search_request"):
...
#     with patch("hope_payment_gateway.apps.western_union.admin.cancel"):
